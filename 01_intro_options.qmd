...
## The Life Cycle of Open Interest {data-state="grid-fine"}
...
## The Life Cycle of Open Interest {data-state="grid-dense"}
...
## Life Cycle of Open Interest: Details {data-state="grid-medium"}

::: {.incremental}
**Growth Phase:**

- New option series starts at OI = 0
- Each new buyer + new seller → OI increases
- Peaks several weeks/months before expiration

**Decline Phase:**

- Traders close positions via offsetting trades
- Some early exercise (American options)
- Risk managers avoid near-expiration options
...
## Why OTM Options Are Popular {data-state="grid-coarse"}

Despite lower probability of profit, OTM options attract significant trading:

::::  {.columns}
::: {.column width="50%"}
**Leverage & Cost**

- Much cheaper than ITM options
- Control more shares per dollar
- Example: $1,000 buys 2 ITM calls or 20 OTM calls
:::

::: {.column width="50%"}
**Other Motivations**

- **Speculation**: Large % returns possible
- **Hedging**: Tail risk protection
- **Pure time value**: Volatility bets
:::
::::

## Observable Market Patterns {data-state="grid-sparse"}

::: {.incremental}
**Strike Distribution:**

- Volume/OI concentrated within 10-20% of current price
- Calls: higher activity above current price
- Puts: higher activity below current price

**Maturity Effects:**

- Near-term (1-8 weeks): highest volume
- Longer-term (3+ months): high OI, lower daily volume
- Final week: volume spikes as positions close

**Liquidity:**

- Deep OTM: infrequent trading, wide bid-ask spreads
- Last trade dates may be days/weeks old
:::
