...
subtitle: "A First Look at Financial Derivatives"
author: "BUSI 721: Data-Driven Finance I"
format:
  revealjs:
    theme: simple
    transition: slide
...
#| fig-height: 450
#| fig-cap: Long call position with K=$100, premium=$5
#| echo: false
...
#| fig-height: 450
#| fig-cap: Long put position with K=$100, premium=$5
#| echo: false
...
#| fig-height: 450
#| fig-cap: Short call position with K=$100, premium=$5
#| echo: false
...
#| fig-height: 450
#| fig-cap: Short put position with K=$100, premium=$5
#| echo: false
...
Today's concepts are essential for all of these topics!
:::
...
- Four main types: forwards, futures, options, swaps
- Massive global market ($667T notional)
- Used for hedging and speculation

**Options:**

- Calls give the right to buy, puts the right to sell
- Buyers have rights, sellers have obligations
- Four basic positions: long/short calls/puts
- Intrinsic value + time value = option price
- Non-linear, time-dependent payoffs
:::
...
- Interactive market data: [options-market-data.koyeb.app](https://options-market-data.koyeb.app/)
- Review the payoff diagrams and practice drawing them yourself
- Think about how you might use options in your own trading or risk management

*Next lecture: Option Portfolios and Strategies*
